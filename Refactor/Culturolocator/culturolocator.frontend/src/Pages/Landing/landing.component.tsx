...
function Landing() {
    return (
        <div className="text-center bg-image rounded-3 w-100 vh-100" style={{
            ...
            <div className="mask w-100 h-100" style={{ backgroundColor: "rgba(0, 0, 0, 0.6)" }} >
                <div className="d-flex justify-content-center align-items-center h-100">
                    <div className="text-white">
                        <h1 className="mb-3 font-monospace display-3 lead">Discover Macedonia's Rich Cultural Heritage</h1>
